...
Read `.github/copilot-instructions.md` first — it is the single source of truth for project conventions, tooling, code style, and architecture. This file contains only Claude-specific extensions.
